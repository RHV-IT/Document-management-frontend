...
const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    id: 2,
    title: 'Scanner Agent',
    description: `The scanner agent connects your physical scanner to this system. It automatically detects when you scan documents and makes them available for upload. The agent runs in the background to keep you connected.`,
  ...
  },
  {
    ...
    description: `Once connected, scanned documents appear as pending files. You'll be asked to confirm each upload, add a friendly name, and set security levels. Files are securely stored and indexed for easy searching.`,
    icon: <UploadCloud className="h-10 w-10 text-amber-500" />,
    animation: 'slide',
  },
  {
    id: 4,
    title: 'Pending Files',
    description: `Scanned documents wait for your approval before being uploaded. You'll see a clear confirmation dialog for each file, ensuring you have full control over what gets added to your document library.`,
    icon: <FolderOpen className="h-10 w-10 text-indigo-500" />,
    animation: 'bounce',
  },
  {
    id: 5,
    title: 'Confirmation Flow',
    description: `For each pending scan, you'll see options to upload or cancel. Upload requires a second confirmation for safety. Cancelled files remain in your scanner folder until you're ready to try again.`,
  ...
  },
  {
    ...
    description: `You now know how scanning and uploading works. The system will guide you through each step. Remember, you can always change your password and adjust settings in your account preferences.`,
